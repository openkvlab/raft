...
func TestSnapshotFailure(t *testing.T) {
	...
	sm.Step(pb.Message{From: new(uint64(2)), To: new(uint64(1)), Type: new(pb.MessageType_MsgSnapStatus), Reject: new(true)})
...
func TestSnapshotSucceed(t *testing.T) {
	...
	sm.Step(pb.Message{From: new(uint64(2)), To: new(uint64(1)), Type: new(pb.MessageType_MsgSnapStatus), Reject: new(false)})
	require.Zero(t, sm.trk.Progress[2].PendingSnapshot)
...
func TestSnapshotAbort(t *testing.T) {
	...
	sm.Step(pb.Message{From: new(uint64(2)), To: new(uint64(1)), Type: new(pb.MessageType_MsgAppResp), Index: new(uint64(11))})
	require.Zero(t, sm.trk.Progress[2].PendingSnapshot)
