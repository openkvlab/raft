...
func TestSnapshotFailure(t *testing.T) {
	...
	sm.Step(pb.Message{From: 2, To: 1, Type: pb.MessageType_MsgSnapStatus, Reject: true})
...
func TestSnapshotSucceed(t *testing.T) {
	...
	sm.Step(pb.Message{From: 2, To: 1, Type: pb.MessageType_MsgSnapStatus, Reject: false})
	require.Zero(t, sm.trk.Progress[2].PendingSnapshot)
...
func TestSnapshotAbort(t *testing.T) {
	...
	sm.Step(pb.Message{From: 2, To: 1, Type: pb.MessageType_MsgAppResp, Index: 11})
	require.Zero(t, sm.trk.Progress[2].PendingSnapshot)
