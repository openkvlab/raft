...
func TestPreVoteWithSplitVote(t *testing.T) {
	...
	nt.isolate(1)
	nt.send(
		&pb.Message{From: new(uint64(2)), To: new(uint64(2)), Type: new(pb.MessageType_MsgHup)},
		&pb.Message{From: new(uint64(3)), To: new(uint64(3)), Type: new(pb.MessageType_MsgHup)},
	)
